...
function user_job_setup()
	...
	state.Weapons:options('Armageddon', 'Gastraphetes', 'SmoothBrain')
	...
	DefaultAmmo = {
		...
		['Crossbow'] = {
			['Default'] = "Abrasion Bolt",
			['WS'] = "Abrasion Bolt",
			['Acc'] = "Abrasion Bolt",
			['Magic'] = "Abrasion Bolt",
			['MagicAcc'] = "Abrasion Bolt",
		}
	}
...
function init_gear_sets()
	...
	gear.ambuMeleeTP = { name="Belenus's Cape", augments={'DEX+20','Accuracy+20 Attack+20','Accuracy+5','"Dbl.Atk."+10','Phys. dmg. taken-10%'}}
	--------------------------------------
	-- Precast sets
	--------------------------------------
	
	-- Precast sets to enhance JAs
	sets.TreasureHunter = set_combine(sets.TreasureHunter, { ammo = empty }) -- stop the egg being loaded!
	...
	sets.weapons.SmoothBrain = {main="Naegling", sub="Blurred Knife +1",range="Anarchy +2"}
