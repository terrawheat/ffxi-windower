...
function init_gear_sets()
    ...
    range="Dunna",
    head={ name="Merlinic Hood", augments={'Mag. Acc.+10','"Conserve MP"+3','MND+10','"Mag.Atk.Bns."+7',}},
    body="Jhakri Robe +2",
    hands="Geo. Mitaines +1",
    legs="Geo. Pants +1",
    feet={ name="Merlinic Crackows", augments={'Mag. Acc.+7 "Mag.Atk.Bns."+7','"Drain" and "Aspir" potency +2','MND+11','Mag. Acc.+5',}},
    ...
    sets.midcast.Geomancy.Indi = set_combine(sets.midcast.Geomancy, { neck="Incanter's Torque",
        legs="Bagua Pants",
    ...
    main={ name="Gada", augments={'"Cure" potency +3%','STR+7','"Mag.Atk.Bns."+15',}},
    sub="Sors Shield",
    range="Dunna",
	neck="Incanter's Torque",
    ...
    sets.midcast.Aspir = set_combine(sets.midcast.Macc, { main ="Rubicundity",
