...
function check_cleanup()
	if state.AutoCleanupMode.value then
		...
		if items.count_sack < items.max_sack then
			if player.inventory['Pellucid Stone'] then send_command('put "Pellucid Stone" case all') moveditem = true end
			if player.inventory['Taupe Stone'] then send_command('put "Taupe Stone" case all') moveditem = true end
			if player.inventory['Fern Stone'] then send_command('put "Fern Stone" case all') moveditem = true end
			if player.inventory['Frayed Sack (Pel)'] then send_command('put "Frayed Sack (Pel)" case all') moveditem = true end
			if player.inventory['Frayed Sack (Tau)'] then send_command('put "Frayed Sack (Tau)" case all') moveditem = true end
			if player.inventory['Frayed Sack (Fer)'] then send_command('put "Frayed Sack (Fer)" case all') moveditem = true end
			if player.inventory['Beitetsu'] then send_command('put Beitetsu case all') moveditem = true end
			if player.inventory['Beitetsu Parcel'] then send_command('put "Beitetsu Parcel" case all') moveditem = true end
			if player.inventory['Beitetsu Box'] then send_command('put "Beitetsu Box" case all') moveditem = true end
			if player.inventory['Pluton'] then send_command('put Pluton case all') moveditem = true end
			if player.inventory['Pluton Case'] then send_command('put "Pluton Case" case all') moveditem = true end
			if player.inventory['Pluton Box'] then send_command('put "Pluton Box" case all') moveditem = true end
			if player.inventory['Riftborn Boulder'] then send_command('put "Riftborn Boulder" case all') moveditem = true end
			if player.inventory['Boulder Case'] then send_command('put "Boulder Case" case all') moveditem = true end
			if player.inventory['Boulder Box'] then send_command('put "Boulder Box" case all') moveditem = true end
		end
