...
local skillchains = {
	[288] = {id=288,english='Light',elements={'Fire','Thunder','Wind','Light'}},
	[289] = {id=289,english='Darkness',elements={'Earth','Water','Ice', 'Dark'}},
...
local elements = {
	['Light'] = {spell='Thunder',helix='Luminohelix',ga=nil,ja=nil,ra=nil},
	['Dark'] = {spell='Blizzard',helix='Noctohelix',ga=nil,ja=nil,ra=nil},
